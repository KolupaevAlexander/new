...
namespace Измерительный_приборы
{
    public partial class Form1 : Form
    {
        ...
        private void DeleteItem(int elementIndex)
        {
        ...
        private void change_Click(object sender, EventArgs e)
        {
            ...
            else if (name.Text != "" && producer.Text != "" && count.Text != "" && price.Text != "" && time.Text != "" && inBox.Text != "")
            {
                ...
                {
                    items.RemoveAt(sel);
                    items.Insert(sel, new Grocery(name.Text, producer.Text, Int32.Parse(count.Text), double.Parse(price.Text), time.Text));
                }
                else 
                {
                    items.RemoveAt(sel);
        ...
        private void ShowListInGrid()
        {
            ...
            else if (grosChoice.Checked) ShowAll(items.Where(i => i is Grocery));
            else ShowAll(items.Where(i => i is Manufactured));
        }
